...
namespace FoodInfo.Service.Migrations
{
    ...
    [Migration("20181022085528_Initial_second")]
            ...
            modelBuilder.Entity("FoodInfo.Service.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { ID = 1, CreatedDate = new DateTime(2018, 10, 22, 10, 55, 28, 756, DateTimeKind.Local), IsDeleted = false, Name = "Fatih", Surname = "Cankurtaran" },
                        new { ID = 2, CreatedDate = new DateTime(2018, 10, 22, 10, 55, 28, 757, DateTimeKind.Local), IsDeleted = false, Name = "Yusuf", Surname = "Kocadas" }
                    );
                });
